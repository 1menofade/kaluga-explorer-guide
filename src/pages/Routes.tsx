...
const tourRoutes: TourRoute[] = [
  {
    ...
    points: [
      { id: 1, name: 'Музей космонавтики', address: 'ул. Академика Королёва, 2, Калуга' },
      { id: 2, name: 'Дом-музей К.Э. Циолковского', address: 'ул. Циолковского, 79, Калуга' },
      { id: 3, name: 'Памятник К.Э. Циолковскому', address: 'площадь Мира, Калуга' }
    ]
  },
  {
    id: 2,
    ...
    points: [
      { id: 4, name: 'Каменный мост', address: 'ул. Пушкина, Калуга' },
      { id: 5, name: 'Гостиный двор', address: 'ул. Ленина, 126, Калуга' },
      { id: 6, name: 'Калужский областной драматический театр', address: 'пл. Театральная, 1, Калуга' }
    ]
  },
  {
    id: 3,
    ...
    points: [
      { id: 5, name: 'Гостиный двор', address: 'ул. Ленина, 126, Калуга' },
      { id: 6, name: 'Палаты Коробовых', address: 'ул. Плеханова, 88, Калуга' },
      { id: 4, name: 'Каменный мост', address: 'ул. Пушкина, Калуга' },
      { id: 7, name: 'Дом Губернатора', address: 'ул. Ленина, 74, Калуга' }
    ]
  }
];
      ...
      <main className="flex-1 py-12 bg-gradient-radial from-white to-kaluga-50">
        <div className="container-custom">
          <div className="text-center mb-16">
            <span className="section-subtitle">Маршруты</span>
            <h1 className="section-title">Готовые маршруты по Калуге</h1>
            <p className="text-kaluga-600 max-w-2xl mx-auto mt-4">
              Выбирайте один из наших тематических маршрутов для знакомства с городом или создайте свой собственный.
            </p>
          </div>
            ...
            <div className="mb-8 animate-fade-in">
              <div className="flex items-center justify-between mb-4">
                <button 
                  ...
                  className="text-kaluga-500 hover:text-kaluga-700 flex items-center"
                >
              ...
              <Card className="overflow-hidden">
                ...
                <CardContent>
                  ...
                  <div className="space-y-4 mb-6">
                    {selectedRoute.points.map((point, index) => (
                      <div key={point.id} className="p-4 border rounded-md bg-kaluga-50/50">
                ...
                <CardFooter className="flex justify-between">
                  ...
                  <a 
                    href={`https://yandex.ru/maps/?mode=routes&rtext=${selectedRoute.points.map(p => p.address.replace(/,\s*Калуга/, '')).join('~')}&rtt=pd`}
                    target="_blank"
          ...
          <div className="mt-12 text-center">
            ...
            <Link 
              to="/attractions"
              className="inline-flex items-center px-6 py-3 bg-kaluga-700 text-white rounded-md hover:bg-kaluga-800 transition-colors"
            >
              <Route size={18} className="mr-2" />
              Составить маршрут
            </Link>
